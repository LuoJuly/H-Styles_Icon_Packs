...
| | |
|---|---|
| Application ID | `cn.luojuly.H2OS` |
| Version | 3.0.0 (17) |
| Dashboard | [Blueprint](https://github.com/jahirfiquitiva/Blueprint) |
| Author | [LuoJuly](https://github.com/LuoJuly) |

Open this folder in Android Studio to build a debug or release APK. JDK 17 and Android SDK 36 are required.
